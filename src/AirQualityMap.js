...
const AirQualityMap = () => {
    ...
    const { cities, city, position, country, convertCountry, address, datasets, currentData, dateRange, monthNames, downloadData, airQualityData, airQuality, airQualityScale } = useContext(AppContext);
